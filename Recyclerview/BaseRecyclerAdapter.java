...
//            holder.itemView.setBackgroundResource(R.mipmap.ic_launcher);//设置背景
        ...
        convert(context,holder, list.get(position), position, isScrolling);
    ...
    public abstract void convert(Context context,BaseRecyclerHolder holder, T item, int position, boolean isScrolling);
